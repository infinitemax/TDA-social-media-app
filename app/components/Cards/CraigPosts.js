    ...
    <div className="relative border-4 border-white rounded-2xl h-40 w-40 sm:h-60 sm:w-60 md:h-96 md:w-96">
      ...
      flex-col justify-center items-center"
            >
              ...
              <p>{content}</p>
              <DeleteButton post={title} 
                handleDeleteInParent={(title) => deleteIt(title)}
              />
          {/* //     <button className='py-2 px-4 rounded-md bg-slate-300 border-2 border-slate-400 w-12 mx-auto text-center' */}
